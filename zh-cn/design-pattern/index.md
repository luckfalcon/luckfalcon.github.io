...
**UML类图**
![UML类图](/content/posts/design-pattern/picture/UML图解.png)
...
![代理模式结构图](/content/posts/design-pattern//picture/proxy.png)
- 代理模式应用
1. 远程代理
...
- 工厂方法模式结构图
![厂方法模式结构图](/content/posts/design-pattern/picture/factory-method.png)
## 原型模式
- 原型模式(Prototype),用原型实例指定创建对象的种类，并且通过拷贝这些原型创建新的对象。
**c++11新特性，协变返回类型**
- 原型模式结构图：
![原型模式结构图](/content/posts/design-pattern/picture/prototype.png)
## 模板方法模式
...
- 模板方法模式
![模板方法模式](/content/posts/design-pattern/picture/TemplateMethod.png)
## 迪米特法则(LoD)
...
外观模式结构图
![外观模式结构图](/content/posts/design-pattern/picture/facade.png)
...
解释器模式结构：
![解释器模式结构](/content/posts/design-pattern/picture/interpreter.png)
